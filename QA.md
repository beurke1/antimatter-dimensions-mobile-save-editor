...
3. Use Copy QA summary for a value-free report suitable for GitHub issues. It includes detected game stage, stage signal paths, coverage counts, unknown top-level counts, safety issue counts, path names, and safety warning samples, but not save values.
