...
- Copy value-free QA summaries with detected game stage, coverage counts, unknown top-level counts, safety issue counts, and warning samples, plus copy/download coverage reports for imported saves.
