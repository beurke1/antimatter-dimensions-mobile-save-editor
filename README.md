...
- Copy value-free QA summaries with detected game stage and stage signal paths, coverage counts, unknown top-level counts, safety issue counts, and warning samples, plus copy/download coverage reports for imported saves.
