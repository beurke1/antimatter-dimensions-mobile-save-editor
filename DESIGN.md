...
- Mobile verification must check rendered iPhone-sized layouts for horizontal overflow, clipped controls, undersized controls, fixed export-bar overlap, representative edits, deep scoped browsing, reset, and encode.
